...
type ListProjectsResponse2 struct {
	Data    []ListProject2 `json:"data"`
	Status  int            `json:"status"`
	Message string         `json:"message"`
}

type ListProjectsResponse3 struct {
	Data    []ListProject3 `json:"data"`
	Status  int            `json:"status"`
	Message string         `json:"message"`
}

type ListProjectsResponse4 struct {
	Data    []ListProject4 `json:"data"`
	Status  int            `json:"status"`
	Message string         `json:"message"`
}
